...
class Discriminator(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.main = nn.Sequential(
            nn.Conv2d(self.num_channels, self.num_features, 4, 2, 1, bias=False),
            nn.LeakyReLU(0.3, inplace=True),

            nn.Conv2d(self.num_features, self.num_features * 2, 4, 2, 1, bias=True),
            ...
            nn.Conv2d(self.num_features * 4, self.num_features * 8, 4, 2, 1, bias=False),
